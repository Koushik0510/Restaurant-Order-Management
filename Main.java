        ...
        for (String foodPrice : fileData.FoodReturn().split(",")) {
            switch (foodIndex) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    foodArrayList.add(new Food("Grill Chicken", Double.parseDouble(foodPrice)));
                    break;
                case 5:
                    foodArrayList.add(new Food("Biriyani", Double.parseDouble(foodPrice)));
                    break;
            }
            foodIndex++;
        }
        ...
        while (true) {
            ...
            if (firstChoosed == 1) {
                ...
                while (again == 0) {
                    ...
                    int CustomerChoosed = input.nextInt();
                    int piece = 0;


                    switch (CustomerChoosed) {
                        case 1:
                            System.out.println("You chose Pizza. ");
                            System.out.println("How many pizza do you want to buy?");
                            piece = input.nextInt();

                            System.out.println("Food Total price is " + payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece));
                            total += payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece);
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            System.out.println("You chose Grill Chicken. ");
                            System.out.println("How many Grill Chicken do you want to buy?");
                            piece = input.nextInt();
                            System.out.println("Food Total price is " + payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece));
                            total += payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece);
                            System.out.println("Total Price is " + total);
                            break;
                        case 5:
                            System.out.println("You chose Biriyani. ");
                            System.out.println("How many Biriyani do you want to buy?");
                            piece = input.nextInt();
                            System.out.println(" FoodTotal price is " + payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece));
                            total += payment.calculateFood(foodArrayList.get(CustomerChoosed - 1).getPrice(), piece);
                            System.out.println("Total Price is " + total);
                            break;
                    ...
                    if (again == 1) {
                        ...
                        if (cash_or_card == 1) {
                            ...
                            System.out.println("Amount paid: " + total + " Process completed by Card.");
                ...
                if (session == 0) {
                    ...
                    username = input.next();
                    controlFor:
                    for (Admin adminKoushik : adminArrayList) {
                        if (username.equals(adminKoushik.getUsername())) {
                            System.out.println("Enter password: ");
                            password = input.nextInt();
                            if (password == adminKoushik.getPassword()) {
                                sessionAdminUsername = adminKoushik.getUsername();
                                sessionAdminPassword = adminKoushik.getPassword();
                                session = 1;
                                break controlFor;
                            } else {
                ...
                if (session == 1) {
                    ...
                    System.out.println("Enter 4 For Grill Chicken");
                    System.out.println("Enter 5 For Biriyani");
                    ...
                    switch (adminChoosed) {
                        ...
                        case 3:
                            ...
                            break AdminPriceSwitch;
                        case 4:
                            System.out.println("Enter new price for Grill Chicken");
                            newPrice = input.nextDouble();
                            fileData.FoodArr(adminChoosed, newPrice);
                            break AdminPriceSwitch;
                        case 5:
                            System.out.println("Enter new price for Biriyani");
                            newPrice = input.nextDouble();
                            fileData.FoodArr(adminChoosed, newPrice);
                            break AdminPriceSwitch;
                        case 6:
